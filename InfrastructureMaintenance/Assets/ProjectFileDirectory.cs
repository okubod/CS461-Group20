...
public class ProjectFileDirectory : MonoBehaviour
{
    ...
    public GameObject Get_Object()
    {
        ...
        else
        {
            ...
            // add to the prefab
            ProjectFileDirectoryObject directory_object = spawned_object.AddComponent<ProjectFileDirectoryObject>();
    ...
    {
        ProjectFileDirectoryObject directory_object = return_object.GetComponent<ProjectFileDirectoryObject>();
...
// identifies the pool
public class ProjectFileDirectoryObject : MonoBehaviour
{
    public ProjectFileDirectory files;
}
