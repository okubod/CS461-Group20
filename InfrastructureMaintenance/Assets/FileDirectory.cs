...
public class FileDirectory : MonoBehaviour
{
    ...
    public GameObject Get_Object()
    {
        ...
        else
        {
            ...
            // add to the prefab
            DirectoryObject directory_object = spawned_object.AddComponent<DirectoryObject>();
    ...
    {
        DirectoryObject directory_object = return_object.GetComponent<DirectoryObject>();
...
// identifies the pool
public class DirectoryObject : MonoBehaviour
{
    public FileDirectory files;
}
