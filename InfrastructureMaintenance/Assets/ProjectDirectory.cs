...
public class ProjectDirectory : MonoBehaviour
{
    ...
    public GameObject Get_Object()
    {
        ...
        else
        {
            ...
            // add to the prefab
            ProjectDirectoryObject directory_object = spawned_object.AddComponent<ProjectDirectoryObject>();
    ...
    {
        ProjectDirectoryObject directory_object = return_object.GetComponent<ProjectDirectoryObject>();
...
// identifies the pool
public class ProjectDirectoryObject : MonoBehaviour
{
    public ProjectDirectory files;
}
